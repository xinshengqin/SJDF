...
# dtopodir = os.path.abspath('/home2/xsqin/clawpack_cases/make_fake_quake')
topodir = os.environ['SJDF_TOPODIR']
dtopodir = os.environ['SJDF_DTOPODIR']
...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times =  list(np.linspace(0,10*60,21)) + \
                                 list(range(15*60,181*60,15*60))
...
#-------------------
    ...
    topofiles.append([3, 1, 1, 0., 1.e10, \
            os.path.join(topodir, 'etopo1_-137_-122_38_54_1min_nc.asc')])
    topofiles.append([3, 1, 1, 0., 1.e10,\
    ...
    dtopotype  = 3
    dtopofiles.append([dtopotype, 3, 3, os.path.join(dtopodir,'./cascadia001297.dtt3')])
...
if __name__ == '__main__':
    ...
    # create fgmax_grid_1.txt, set to record fgmax on finest grid only:
    from make_fgmax import make_fgmax_grid_1
    make_fgmax_grid_1(rundata.amrdata.amr_levels_max)
